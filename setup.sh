...
brew install --cask google-chrome ghostty slack jetbrains-toolbox visual-studio-code dockdoor raycast docker-desktop android-studio antigravity codex claude-code
